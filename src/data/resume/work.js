 ...
 * @property {string} startDate - Start date of the position in YYY-MM-DD format
 * @property {string|undefined} endDate - End date of the position in YYY-MM-DD format.
